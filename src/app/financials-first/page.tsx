...
const PRICING_TABLE = [
  { client: "$7,500", source: "$3,750", margin: "$3,750", pct: "50%" },
  { client: "$15,000", source: "$7,500", margin: "$7,500", pct: "50%" },
  { client: "Above $25,000", source: "Custom", margin: "Custom", pct: "" },
];
...
const TERMS_TABS = {
  ...
  Delivery: [
    "Target: sub-30 days from kick-off to go-live — does not include partner or end-client delays",
    ...
    <div className="min-h-screen bg-[#fafafa] text-black">
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="bg-white border border-black/[0.08] mb-6">
          ...
          <ScopeSection title="Reporting & Dashboards" items={REPORTING} owner="source" defaultOpen />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[14px] sm:text-[15px] text-black/55 leading-[1.65]">
                ...
                per project. This includes custom API connections, custom SuiteScript workflows, and external services
