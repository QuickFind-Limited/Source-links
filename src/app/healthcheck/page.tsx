...
// ─── What Source Looks For ──────────────────────────────────────────────────

const COVERAGE_AREAS: { label: string; desc: string; Icon: ElementType }[] = [
  {
    label: "Old & Unused Scripts",
    desc: "SuiteScripts, RESTlets, workflows, scheduled jobs with zero invocations or stale deploys.",
    Icon: Code2,
  },
  {
    label: "Unused Licenses",
    desc: "Modules paid for and never adopted, dormant user seats, over-licensed roles.",
    Icon: CreditCard,
  },
  {
    label: "Security Audit",
    desc: "Admin sprawl, missing segregation of duties, stale users, role overreach.",
    Icon: Shield,
  },
  {
    label: "Process Identification",
    desc: "Steps happening outside the ERP, manual workarounds, bottlenecks in close and AP.",
    Icon: Workflow,
  },
  {
    label: "AI Automation Opportunities",
    desc: "Repetitive manual work, document parsing, reconciliation, approvals ready for AI.",
    Icon: Sparkles,
  },
  {
    label: "Legacy & Old Code",
    desc: "Deprecated APIs, abandoned customisations, scripts on retired SuiteScript versions.",
    Icon: Trash2,
  },
  {
    label: "Data Quality Issues",
    desc: "Duplicates, GL imbalance, missing tax IDs, stale items, broken referential integrity.",
    Icon: Database,
  },
  {
    label: "Fix Plan for Each Issue",
    desc: "Every finding maps to a remediation step with effort estimate and SOW line.",
    Icon: Wrench,
  },
];
...
const DIMENSIONS_DETAIL: {
  ...
  },
  {
    ...
    Icon: Workflow,
    examples: [
      "Source found manual journal entries account for 34% of all GL postings — AI automation opportunity",
      ...
      "Source identified 1,200 invoices/month manually keyed from PDF — AI document-parsing candidate",
      "Source flagged 3-step manual approval chain on POs <$5K — workflow automation opportunity",
    ],
  },
  {
  ...
  },
  {
    ...
    examples: [
      ...
      "Source flagged 47 scheduled scripts — 19 have not run in 12+ months and can be safely retired",
      "Source detected 12 SuiteScripts still on SuiteScript 1.0 (deprecated) — migration required",
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-[17px] sm:text-[20px] italic text-black/55 leading-[1.5]">
            ...
            really operating &mdash; before a statement of work. No more
            &ldquo;trust me, here&apos;s what&apos;s broken&rdquo; &mdash; the
            client sees the evidence themselves.
          </p>
        </div>
            ...
            <div className="md:flex-1 p-4 sm:p-6 md:border-r border-b md:border-b-0 border-black/[0.06] flex flex-col">
              ...
              <div className="border-2 border-black/[0.08] px-6 sm:px-8 py-5 sm:py-6 mb-5">
                ...
                <p className="text-[14px] sm:text-[15px] text-black/50 mt-3 leading-[1.65]">
                  Source Healthcheck scans any ERP environment &mdash; multiple systems, any platform &mdash; and delivers evidence-backed findings in 24 hours. Every finding is quantified and maps directly to a scoped SOW. Partners offer the healthcheck free to prospects, Source delivers the intelligence.
                </p>
              </div>
              ...
              <div className="bg-[#f7f7f5] border border-black/[0.08] px-5 sm:px-9 py-6 sm:py-8 mb-5">
                ...
                <p className="text-[17px] sm:text-[21px] italic leading-[1.6] text-black/70 mb-5">
                  &ldquo;We offer a free healthcheck to every prospect.
                ...
                <div className="pt-4 border-t border-black/[0.08] space-y-1.5">
                  ...
                  <div className="flex items-start gap-2 pt-3 mt-1 border-t border-black/[0.06]">
                    <Camera
                      className="w-3.5 h-3.5 text-black/35 shrink-0 mt-[3px]"
                      strokeWidth={1.75}
                    />
                    <div className="text-[12px] sm:text-[13px] text-black/50 leading-[1.6]">
                      Like an oil change with photos of the undercarriage &mdash;
                      the client sees the evidence on screen, timestamped, with
                      query output attached. The trust gap closes before the
                      pricing conversation starts.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white border border-black/[0.08] mb-6">
          <div className="px-4 sm:px-5 py-4 border-b border-black/[0.06]">
            <div className="text-[15px] sm:text-[18px] font-medium tracking-tight text-black mb-1">
              Eight Coverage Areas, Every Healthcheck
            </div>
            <div className="text-[13px] sm:text-[14px] text-black/45 leading-snug">
              Every Source healthcheck reviews each of these areas across the live system. Findings are quantified, prioritised, and mapped to a fix.
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-black/[0.06]">
            {COVERAGE_AREAS.map(({ label, desc, Icon }, i) => (
              <div
                key={label}
                className={`p-4 sm:p-5 ${
                  i >= 2 ? "sm:border-t sm:border-black/[0.06]" : ""
                }`}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-[14px] sm:text-[15px] font-semibold text-black/85 mb-1">
                      {label}
                    </div>
                    <div className="text-[12px] sm:text-[13px] text-black/50 leading-[1.55]">
                      {desc}
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white border border-black/[0.08] mb-6">
          ...
          <div className="px-4 sm:px-5 py-4 sm:py-5">
            ...
            <div className="bg-[#f8f8f6] border border-black/[0.06] px-4 py-3">
              <div className="text-[12px] sm:text-[13px] text-black/55 leading-[1.65]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black/[0.06]">
            {[
              ...
              <div key={label} className="p-5 sm:p-6">
                ...
                <div className="text-[10px] font-mono uppercase tracking-[0.10em] text-black/30 pt-2 border-t border-black/[0.06]">
                  {tag}
                </div>
              </div>
            ))}
        ...
        <div className="bg-black p-4 sm:p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-5">
            {[
              {
                title: "Free for Prospects",
                desc: "Partners offer the healthcheck free to every prospect. Source delivers the intelligence in 24hrs.",
              },
              {
